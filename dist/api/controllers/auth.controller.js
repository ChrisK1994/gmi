...
const { SEC_ADMIN_EMAIL, JWT_EXPIRATION_MINUTES, emailEnabled } = require('../../config/vars');
/**
...
exports.logout = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield RefreshToken.findAndDeleteToken({ userId });
 ...
 * @public
 */
exports.oAuth = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { user } = req;
 ...
 * @public
 */
exports.refresh = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
