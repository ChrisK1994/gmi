 ...
 * @public
 */
exports.load = (req, res, next, id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
 ...
 * @public
 */
exports.replace = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
 ...
 */
exports.listUserNotes = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        Utils_1.startTimer({ req });
        const userId = req.params.userId;
        req.query = Object.assign(Object.assign({}, req.query), { user: new ObjectId(userId) }); // append to query (by userId) to final query
 ...
 * @public
 */
exports.deleteUserNote = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        yield models_1.UserNote.deleteOne({ user: new ObjectId(userId), _id: new ObjectId(noteId) });
